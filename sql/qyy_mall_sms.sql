/*
 ...
 Source Schema         : qyy_mall_sms

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 11/12/2022 00:21:03
*/
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券领取历史记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_spu_category_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券分类关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_spu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券与产品关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_adv`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页轮播广告' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_subject_spu`  (
  ...
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '专题商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 64 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (31, 16, 2, '铜牌会员', 900.0000, 1);
INSERT INTO `sms_member_price` VALUES (32, 16, 3, '银牌会员', 800.0000, 1);
INSERT INTO `sms_member_price` VALUES (33, 17, 2, '铜牌会员', 1900.0000, 1);
INSERT INTO `sms_member_price` VALUES (34, 17, 3, '银牌会员', 1800.0000, 1);
INSERT INTO `sms_member_price` VALUES (35, 18, 2, '铜牌会员', 900.0000, 1);
INSERT INTO `sms_member_price` VALUES (36, 18, 3, '银牌会员', 800.0000, 1);
INSERT INTO `sms_member_price` VALUES (37, 19, 2, '铜牌会员', 1900.0000, 1);
INSERT INTO `sms_member_price` VALUES (38, 19, 3, '银牌会员', 1800.0000, 1);
INSERT INTO `sms_member_price` VALUES (39, 20, 2, '铜牌会员', 900.0000, 1);
INSERT INTO `sms_member_price` VALUES (40, 20, 3, '银牌会员', 800.0000, 1);
INSERT INTO `sms_member_price` VALUES (41, 21, 2, '铜牌会员', 1900.0000, 1);
INSERT INTO `sms_member_price` VALUES (42, 21, 3, '银牌会员', 1800.0000, 1);
INSERT INTO `sms_member_price` VALUES (43, 22, 2, '铜牌会员', 900.0000, 1);
INSERT INTO `sms_member_price` VALUES (44, 22, 3, '银牌会员', 800.0000, 1);
INSERT INTO `sms_member_price` VALUES (45, 23, 2, '铜牌会员', 1900.0000, 1);
INSERT INTO `sms_member_price` VALUES (46, 23, 3, '银牌会员', 1800.0000, 1);
INSERT INTO `sms_member_price` VALUES (47, 24, 2, '铜牌会员', 4500.0000, 1);
INSERT INTO `sms_member_price` VALUES (48, 24, 3, '银牌会员', 4000.0000, 1);
INSERT INTO `sms_member_price` VALUES (49, 25, 2, '铜牌会员', 5500.0000, 1);
INSERT INTO `sms_member_price` VALUES (50, 25, 3, '银牌会员', 5000.0000, 1);
INSERT INTO `sms_member_price` VALUES (53, 27, 2, '铜牌会员', 4500.0000, 1);
INSERT INTO `sms_member_price` VALUES (54, 27, 3, '银牌会员', 4000.0000, 1);
INSERT INTO `sms_member_price` VALUES (55, 28, 2, '铜牌会员', 5500.0000, 1);
INSERT INTO `sms_member_price` VALUES (56, 28, 3, '银牌会员', 5000.0000, 1);
INSERT INTO `sms_member_price` VALUES (59, 30, 2, '铜牌会员', 4500.0000, 1);
INSERT INTO `sms_member_price` VALUES (60, 30, 3, '银牌会员', 4000.0000, 1);
INSERT INTO `sms_member_price` VALUES (61, 31, 2, '铜牌会员', 5500.0000, 1);
INSERT INTO `sms_member_price` VALUES (62, 31, 3, '银牌会员', 5000.0000, 1);
...
CREATE TABLE `sms_seckill_promotion`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀活动' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀活动场次' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_seckill_sku_notice`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀商品通知订阅' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品满减信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (16, 16, 500.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (24, 24, 1000.0000, 60.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (16, 16, 5, 0.95, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (24, 24, 5, 0.98, NULL, 0);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (7, 26, 500.0000, 500.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (8, 27, 1000.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (9, 28, 1000.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (10, 29, 1000.0000, 1000.0000, NULL);
