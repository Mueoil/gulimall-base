/*
 ...
 Source Schema         : qyy_mall_pms

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 11/12/2022 00:20:57
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (9, '华为', 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-11-25/b0baa39b-a68e-44a1-8bf4-5b4ccb2b11d2_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (10, '小米', 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-11-25/62aec774-30f8-4ca8-88cc-2483ddd53fb7_xiaomi.png', '小米', 1, 'M', 1);
INSERT INTO `pms_brand` VALUES (11, 'OPPO', 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-11-25/ac702720-e62c-49af-8ae1-9484cf4bb3c2_oppo.png', 'OPPO', 1, 'O', 1);
INSERT INTO `pms_brand` VALUES (12, '苹果', 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-11-25/7ecb0183-75ab-48dd-8492-cc3be0939c2f_apple.png', '苹果', 1, 'A', 0);
...
INSERT INTO `pms_category` VALUES (1433, '1', 22, 3, 0, 0, '1', '1', NULL);
INSERT INTO `pms_category` VALUES (1434, '2', 1, 2, 0, 0, '', '', NULL);
INSERT INTO `pms_category` VALUES (1435, '3', 1, 2, 0, 0, '', '', NULL);
INSERT INTO `pms_category` VALUES (1436, '2', 1, 2, 0, 0, '', '', NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for pms_category_brand_relation_copy1
-- ----------------------------
DROP TABLE IF EXISTS `pms_category_brand_relation_copy1`;
CREATE TABLE `pms_category_brand_relation_copy1`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `brand_id` bigint NULL DEFAULT NULL COMMENT '品牌id',
  `catelog_id` bigint NULL DEFAULT NULL COMMENT '分类id',
  `brand_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `catelog_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation_copy1
-- ----------------------------
...
CREATE TABLE `pms_comment_replay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品评价回复关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 86 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (61, 27, 7, '入网型号', 'A2892', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (62, 27, 8, '上市年份', '2019', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (63, 27, 13, '机身长度（mm）', '135.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (64, 27, 14, '机身材质工艺', '以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (65, 27, 15, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (66, 27, 16, 'CPU型号', 'A16', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (73, 29, 7, '入网型号', 'A2892', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (74, 29, 8, '上市年份', '2019', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (75, 29, 13, '机身长度（mm）', '135.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (76, 29, 14, '机身材质工艺', '以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (77, 29, 15, 'CPU品牌', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (78, 29, 16, 'CPU型号', 'A16', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (79, 26, 7, '入网型号', 'ALO-AL00', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (80, 26, 8, '上市年份', '2019', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (81, 26, 11, '机身颜色', '黑色', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (82, 26, 13, '机身长度（mm）', '158.3', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (83, 26, 14, '机身材质工艺', '陶瓷;玻璃', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (84, 26, 15, 'CPU品牌', '海思（Hisilicon）', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (85, 26, 16, 'CPU型号', 'HUAWEI Kirin 970', NULL, 0);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 234 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (109, 16, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (112, 16, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4f25d15d-0108-43c8-8d3a-b3417160b6b1_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (115, 16, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/8627bf93-14b6-4210-8bfb-abe7b9fef60a_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (118, 17, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (121, 17, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4f25d15d-0108-43c8-8d3a-b3417160b6b1_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (124, 17, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/8627bf93-14b6-4210-8bfb-abe7b9fef60a_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (127, 18, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (131, 18, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4cb26985-aabe-4913-8695-6afd6086b0cb_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (134, 18, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/1d3ef8e8-3fa5-47a9-82e7-04e4451aeba1_335b2c690e43a8f8.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (136, 19, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (140, 19, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4cb26985-aabe-4913-8695-6afd6086b0cb_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (143, 19, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/1d3ef8e8-3fa5-47a9-82e7-04e4451aeba1_335b2c690e43a8f8.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (145, 20, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (150, 20, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/e145781a-5410-4f98-801b-84498d8ece78_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (153, 20, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/decaa43a-5756-4655-84ff-90f48ac3b12e_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (154, 21, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (159, 21, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/e145781a-5410-4f98-801b-84498d8ece78_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (162, 21, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/decaa43a-5756-4655-84ff-90f48ac3b12e_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (163, 22, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (166, 22, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4f25d15d-0108-43c8-8d3a-b3417160b6b1_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (169, 22, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/8627bf93-14b6-4210-8bfb-abe7b9fef60a_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (172, 23, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (175, 23, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4f25d15d-0108-43c8-8d3a-b3417160b6b1_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (178, 23, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/8627bf93-14b6-4210-8bfb-abe7b9fef60a_73ab4d2e818d2211.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (181, 24, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (184, 24, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/84ea7598-e890-4c29-8993-ea24f936c63f_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (187, 25, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (190, 25, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/84ea7598-e890-4c29-8993-ea24f936c63f_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (193, 26, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (196, 26, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/84ea7598-e890-4c29-8993-ea24f936c63f_b8494bf281991f94.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (200, 27, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (203, 27, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/c8170828-4c5b-40bc-8758-8bc8b8ade35b_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (206, 28, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (209, 28, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/c8170828-4c5b-40bc-8758-8bc8b8ade35b_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (212, 29, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (215, 29, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/c8170828-4c5b-40bc-8758-8bc8b8ade35b_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (219, 30, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (222, 30, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/9218aaba-ff22-4ae6-8ce7-a9b10577f5c3_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (225, 31, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (228, 31, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/9218aaba-ff22-4ae6-8ce7-a9b10577f5c3_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (231, 32, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (234, 32, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/9218aaba-ff22-4ae6-8ce7-a9b10577f5c3_23cd65077f12f7f5.jpg', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (16, 26, 'HUAWEI META 30 Pro 星河银 8GB+128GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 星河银 8GB+128GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 1000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 26, 'HUAWEI META 30 Pro 星河银 8GB+256GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 星河银 8GB+256GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 2000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 26, 'HUAWEI META 30 Pro 亮黑色 8GB+128GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 亮黑色 8GB+128GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 1000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 26, 'HUAWEI META 30 Pro 亮黑色 8GB+256GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 亮黑色 8GB+256GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 2000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 26, 'HUAWEI META 30 Pro 翡冷绿 8GB+128GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 翡冷绿 8GB+128GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 1000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (21, 26, 'HUAWEI META 30 Pro 翡冷绿 8GB+256GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 翡冷绿 8GB+256GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 2000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (22, 26, 'HUAWEI META 30 Pro 罗兰紫 8GB+128GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 罗兰紫 8GB+128GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 1000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (23, 26, 'HUAWEI META 30 Pro 罗兰紫 8GB+256GB', NULL, 225, 9, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', 'HUAWEI META 30 Pro 罗兰紫 8GB+256GB 华为麒麟990E', '【全新正品、现货速发】送品牌无线充+蓝牙耳机+三合一数据线+钢化膜【推荐5G手机华为mate40e】', 2000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (24, 27, 'Apple iPhone 14 Pro 深空黑色 128GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', 'Apple iPhone 14 Pro 深空黑色 128GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (25, 27, 'Apple iPhone 14 Pro 深空黑色 256GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', 'Apple iPhone 14 Pro 深空黑色 256GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (26, 27, 'Apple iPhone 14 Pro 深空黑色 512GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', 'Apple iPhone 14 Pro 深空黑色 512GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 7000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (27, 27, 'Apple iPhone 14 Pro 玫瑰红 128GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', 'Apple iPhone 14 Pro 玫瑰红 128GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (28, 27, 'Apple iPhone 14 Pro 玫瑰红 256GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', 'Apple iPhone 14 Pro 玫瑰红 256GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (29, 27, 'Apple iPhone 14 Pro 玫瑰红 512GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', 'Apple iPhone 14 Pro 玫瑰红 512GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 7000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (30, 27, 'Apple iPhone 14 Pro 银色 128GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', 'Apple iPhone 14 Pro 银色 128GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (31, 27, 'Apple iPhone 14 Pro 银色 256GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', 'Apple iPhone 14 Pro 银色 256GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (32, 27, 'Apple iPhone 14 Pro 银色 512GB', NULL, 225, 12, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', 'Apple iPhone 14 Pro 银色 512GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 7000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (33, 29, 'Apple iPhone 14 Pro 红色 256GB', NULL, 225, 12, '', 'Apple iPhone 14 Pro 红色 256GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (34, 29, 'Apple iPhone 14 Pro 红色 512GB', NULL, 225, 12, '', 'Apple iPhone 14 Pro 红色 512GB 5G手机 全网通', '全新国行正品、现货速发！送20W充电器+钢化膜+保护壳【苹果14promax】', 10000.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 67 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 16, 9, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 16, 12, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 17, 9, '颜色', '星河银', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 17, 12, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 18, 9, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 18, 12, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 19, 9, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 12, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 20, 9, '颜色', '翡冷绿', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 12, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 21, 9, '颜色', '翡冷绿', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (41, 21, 12, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (42, 22, 9, '颜色', '罗兰紫', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (43, 22, 12, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (44, 23, 9, '颜色', '罗兰紫', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (45, 23, 12, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (46, 24, 9, '颜色', '深空黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (47, 24, 12, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (48, 25, 9, '颜色', '深空黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (49, 25, 12, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (50, 26, 9, '颜色', '深空黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (51, 26, 12, '版本', '512GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (52, 27, 9, '颜色', '玫瑰红', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (53, 27, 12, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (54, 28, 9, '颜色', '玫瑰红', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (55, 28, 12, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (56, 29, 9, '颜色', '玫瑰红', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (57, 29, 12, '版本', '512GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (58, 30, 9, '颜色', '银色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (59, 30, 12, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (60, 31, 9, '颜色', '银色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (61, 31, 12, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (62, 32, 9, '颜色', '银色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (63, 32, 12, '版本', '512GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (64, 33, 9, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (65, 33, 12, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (66, 34, 9, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (67, 34, 12, '版本', '512GB', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 101 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (83, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/63bfbe5b-4d86-48b4-8105-6b6630383c67_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (84, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/a813df9b-0e65-4810-8ed9-da1caaaea535_1f15cdbcf9e1273c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (85, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/227a30ee-0f80-4914-8c0e-d001bc519444_2b1837c6c50add30.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (86, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4f25d15d-0108-43c8-8d3a-b3417160b6b1_919c850652e98031.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (87, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/4cb26985-aabe-4913-8695-6afd6086b0cb_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (88, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/e145781a-5410-4f98-801b-84498d8ece78_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (89, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/8627bf93-14b6-4210-8bfb-abe7b9fef60a_73ab4d2e818d2211.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (90, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/1d3ef8e8-3fa5-47a9-82e7-04e4451aeba1_335b2c690e43a8f8.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (91, 26, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/decaa43a-5756-4655-84ff-90f48ac3b12e_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (92, 27, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/42c850cd-1f5b-45ea-8e2d-9a9b9e8ae2ee_a2c208410ae84d1f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (93, 27, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/783ddf88-87f9-4f46-8546-39c8f49c7c9e_6a1b2703a9ed8737.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (94, 27, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/131c2cef-8acb-4577-8b83-8a50c2b30f25_749d8efdff062fb0.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (95, 27, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/84ea7598-e890-4c29-8993-ea24f936c63f_b8494bf281991f94.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (96, 27, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/c8170828-4c5b-40bc-8758-8bc8b8ade35b_5b5e74d0978360a1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (97, 27, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/9218aaba-ff22-4ae6-8ce7-a9b10577f5c3_23cd65077f12f7f5.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (100, 29, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/55c42d2f-9876-46a8-8c02-19e29e2f9af3_6a1b2703a9ed8737.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (101, 29, NULL, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/726f678d-a375-45a8-831b-707d8b2b5c61_5b5e74d0978360a1.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (26, 'HUAWEI META 30 Pro', 'HUAWEI META 30 Pro', 225, 9, 1.6880, 0, '2022-12-05 16:25:38', '2022-12-05 16:25:38');
INSERT INTO `pms_spu_info` VALUES (27, 'Apple iPhone 14 Pro', 'Apple iPhone 14 Pro', 225, 12, 0.3900, 0, '2022-12-05 17:10:39', '2022-12-05 17:10:39');
INSERT INTO `pms_spu_info` VALUES (29, 'Apple iPhone 14 Pro', 'Apple iPhone 14 Pro', 225, 12, 0.9300, 0, '2022-12-05 20:33:28', '2022-12-05 20:33:28');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (26, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/fb5c62fe-bbf7-432f-8250-34b7f6659a0c_73366cc235d68202.jpg,https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/030d3eb8-b728-4fe8-85fb-9861c95daf3e_528211b97272d88a.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (27, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/1c57f2cb-d8f5-4768-8089-066e47002c7c_7ae0120ec27dc3a7.jpg,https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/8f53870f-4b85-4cb3-888a-12233a42aac0_f205d9c99a2b4b01.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (29, 'https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/242f7259-21fb-4a61-837d-b0a670525908_7ae0120ec27dc3a7.jpg,https://youyu-mall.oss-cn-beijing.aliyuncs.com/2022-12-05/b0fbe1f4-b646-43d9-8b8b-16ebd7f2f873_f205d9c99a2b4b01.jpg');
